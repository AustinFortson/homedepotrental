...
import { addToCart, showTool } from '../../actions/cartactions';
...
const mapDispatchToProps= (dispatch)=>{
    ...
    return{
        ...
        showTool: (name)=>{dispatch(showTool(name))}
    }
}
...
class RentTools extends React.Component {
    ...
    handleClick = (name)=>{
        ...
        // Functionality of View Tool
        viewClick = (name)=>{
            this.props.showTool(name);
            ...
            <div>
                ...
                <ul className="tools">
                    ...
                    <li className="tool">
                        ...
                        viewClick={ ()=>{this.viewClick(Tool.name)} }
                        />
                    </li> 
                    </Col>                       
                    )}
